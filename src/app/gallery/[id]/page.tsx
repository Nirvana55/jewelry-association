...
const Photos = () => {
  return (
    <CustomResponsiveContainer className=' container mx-auto max-[390px]:max-w-[360px] max-lg:max-w-[980px] max-lg:px-2 py-10 cursor animate-fade-right animate-ease-in'>
